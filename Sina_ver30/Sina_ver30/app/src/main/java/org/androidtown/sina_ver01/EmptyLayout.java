...
public class EmptyLayout extends AppCompatActivity implements TextEditorDialogFragment.OnTextLayerCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        play_btn = findViewById(R.id.music);
        ...
        save_Btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(EmptyLayout.this, CalendarActivity.class);
    ...
    private void saveData() {
        ...
        DatabaseReference mRef = FirebaseDatabase.getInstance().getReference().child("users").child(mUser.getUid()).child("diary").child("empty");

        int type = 4;
        String capture = Utils.bitmapToString(getApplicationContext(),captureView);
        String weather = mDisplayWeather.getText().toString();
        //String subtitle, int emotion, String date, int type, String weather, String capture
        DiaryData diaryData = new DiaryData(subtitle,emotion,Utils.dateToString(date.getTime()),type,weather,capture);
