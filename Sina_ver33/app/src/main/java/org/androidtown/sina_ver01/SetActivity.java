...
public class SetActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static String fonts="fonts/bmjua_ttf.ttf";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setToolBar();
        setDrawer();
        navigationView = (NavigationView) findViewById(R.id.set_navi);
    ...
    private void setDrawer() {
        drawer = findViewById(R.id.drawer_set2);
