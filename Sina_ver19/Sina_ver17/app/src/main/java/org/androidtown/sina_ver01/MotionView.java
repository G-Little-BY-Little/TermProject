...
*/
    ...
    private void init(@NonNull Context context) {
       ...
       selectedLayerPaint.setAntiAlias(true);
        selectedLayerPaint.setStrokeWidth(15f);
        selectedLayerPaint.setColor(Color.BLUE);
        selectedLayerPaint.setStyle(Paint.Style.STROKE);
        selectedLayerPaint.setStrokeJoin(Paint.Join.ROUND);
...
*/
    ...
    protected void onDraw(Canvas canvas) {
        ...
        super.onDraw(canvas);
        canvas.drawPath(path, selectedLayerPaint);
    }
